...
const photos: PhotoItem[] = [
  ...
  { id: 7, src: "/07.jpg", caption: "А тут ты королева, ни меньше 👸" },
  { id: 8, src: "/08.jpg", caption: "Вот такие МЫ 🫶" },
  { id: 9, src: "/09.jpg", caption: "Счастливый момент 🥰" },
  { id: 10, src: "/10.jpg", caption: "Тут я чёто хаваю и люблю тебя 😍" },
  { id: 11, src: "/11.jpg", caption: "Наверно в шоках от моей любви" },
